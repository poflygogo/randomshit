...
def path_finder(graph: list, max_row: int, max_col: int) -> bool:
    ...
    def expand(queue: deque, seen_self: set, seen_other: set) -> bool:
        ...
        if (r, c) in seen_other:
            return True
        elif (r, c) not in seen_self and r < max_row and graph[r][c] == '.':
            seen_self.add((r, c))
            queue.append((r, c))
        ...
        if (r, c) in seen_other:
            return True
        elif (r, c) not in seen_self and 0 <= r and graph[r][c] == '.':
            seen_self.add((r, c))
            queue.append((r, c))
        ...
        if (r, c) in seen_other:
            return True
        elif (r, c) not in seen_self and c < max_col and graph[r][c] == '.':
            seen_self.add((r, c))
            queue.append((r, c))
        ...
        if (r, c) in seen_other:
            return True
        elif (r, c) not in seen_self and 0 <= c and graph[r][c] == '.':
            seen_self.add((r, c))
            queue.append((r, c))
